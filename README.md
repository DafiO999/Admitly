...
- **Live Demo:** [admitly-185-129-51-8.sslip.io](https://admitly-185-129-51-8.sslip.io)
- **Repository:** [github.com/DafiO999/Admitly](https://github.com/DafiO999/Admitly)
- **Team:** Kilocraft
...
- Во время параллельной разработки frontend временно использовал внутреннее рабочее название Atlas, а backend — Admitly. Оба названия относились к одному проекту команды Kilocraft для LOCUS. После согласования Admitly стало официальным названием; исторические commits, CSS-классы и имена файлов с Atlas относятся к прежнему внутреннему codename.
...
|---|---|
| Родион Грошев (Rodion Groshev) | Team Lead, cybersecurity |
| Цымбал Данил (Danil Tsymbal) | Backend development |
| Ципринский Илья (Ilya Tsiprinskiy) | Product and UI/UX design |
| Никита Остапенко (Nikita Ostapenko) | Frontend development, QA |
| Даниил Дорошкевич (Daniil Doroshkevich) | Backend development |

Команда совместно разработала Admitly для **LOCUS Startup Hackathon 2026, Case 2 — Admission Journey**.

## Ограничения

- Первая версия поддерживает программы бакалавриата только в США.
- Оценка соответствия не является прогнозом поступления.
- В интерфейсе доступны только направления, для которых сервис может сформировать полноценный подбор.
